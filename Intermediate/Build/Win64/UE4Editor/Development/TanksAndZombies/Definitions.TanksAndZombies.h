...
#define ORIGINAL_FILE_NAME "UE4Editor-TanksAndZombies.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME TanksAndZombies
#define DEPRECATED_FORGAME DEPRECATED
#define TANKSANDZOMBIES_API DLLEXPORT
